      ...
      <section className="relative flex flex-col items-center justify-center min-h-[85vh] px-6 pt-16 pb-20 overflow-hidden border-b border-[#1b1f2b]">
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto">
          ...
          <div className="flex justify-start mb-6">
            <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full border border-[#2a2f40] bg-[#11131b]">
          ...
          {/* Text Alignment Row (Split like reference image) */}
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-end mb-10 text-left">
            <div className="lg:col-span-8">
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-[68px] font-black tracking-tight leading-[1.05] font-display text-white">
